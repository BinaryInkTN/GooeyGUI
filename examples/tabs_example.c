...
int main()
{
    ...
    GooeyLabel *dropdownLabel = GooeyLabel_Create("Select Quality:", 0.26f, 30, 10);
    GooeyLabel *colorLabel = GooeyLabel_Create("Select Color:", 0.26f, 30, 60);

    // Tab 3: Form Inputs
    GooeyTabs_InsertTab(mainTabs, "Forms");

    // Widgets for Forms tab
    GooeyLabel *nameLabel = GooeyLabel_Create("Name:", 0.26f, 30, 30);
    GooeyTextbox *nameTextbox = GooeyTextBox_Create(100, 30, 200, 25, "Name:", NULL);

    GooeyLabel *emailLabel = GooeyLabel_Create("Email:", 0.26f, 30, 70);
