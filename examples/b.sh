...
cd .. && cmake -S . -B build -DCMAKE_POLICY_VERSION_MINIMUM=3.5 && cd build && make -j 12 && sudo make install && cd .. && cd examples &&  gcc canvas_test.c  -o canvas_test -L/usr/local/lib/ -lcjson -lfreetype -lGooeyGUI-1 -lcurl -I/usr/local/include/ -I/usr/local/include/Gooey/ -I/usr/local/include/GLPS/ -lGLPS  -lm && ./canvas_test
